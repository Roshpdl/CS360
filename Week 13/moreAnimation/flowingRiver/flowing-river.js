...
function init() {
	...
	// TEXTURES
	texture.crate = THREE.ImageUtils.loadTexture( path + '../textures/crate.gif' );
	texture.grid = THREE.ImageUtils.loadTexture( path + '../textures/ash_uvgrid01.jpg');
	texture.water = THREE.ImageUtils.loadTexture( path + '../textures/water.jpg' );
	texture.concrete = THREE.ImageUtils.loadTexture( path + '../textures/concrete.jpg' );
	texture.letterR = THREE.ImageUtils.loadTexture( path + '../textures/r_border.png' );
