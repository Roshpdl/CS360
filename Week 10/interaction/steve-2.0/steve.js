...
function onKeyDown( event ) {
    ...
    switch ( event.keyCode ) {
        ...
        case 84: // t - teleport to initial position
            steve.position.x = 0;
            steve.position.z = 0;
            break;
...
// an event handler for mouse clicks - clicking in the upper part of the window
// causes Steve's Y position to increase, while clicking in the lower part of the
// window causes Steve's Y position to decrease
function onMouseClick (event) {
    var my = event.clientY;
    // there should be only one canvas
