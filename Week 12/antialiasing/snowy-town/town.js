...
// create cloud of points that can be added to the scene all at once
var snowField = new THREE.Points( snowGeometry, snowMaterial );
                     
scene.add( snowField );

var posY = 0;

// each time snowStorm() is called, cloud of points is moved down
function snowStorm () {
   if (snowField != null) {
...
// drop the cloud of points onto the town
var clock = setInterval(snowStorm, 200);